 ...
 */
final class Version20250624134244 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE prospect CHANGE message message TEXT NOT NULL
        SQL);
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE prospect CHANGE message message LONGTEXT NOT NULL
        SQL);
    }
}
